            ...
            <div class="col s9">
                <div class="card">
                    <div class="card-image">
                        ...
                        <span class="card-title"><?php echo 'Peminjam : '. $detailPinjam->nama_user; ?></span>
                    </div>
                    <div class="card-content">
                        <h5><?php echo $detailPinjam->nama_ruang; ?></h5>
                        <p>
                            <?php echo 'Acara : '. $detailPinjam->keterangan; ?>
                        </p>
                    </div>
                </div>
                <!-- <div class="card-panel  orange lighten-5">
                    <h5 ><?php echo $detailPinjam->nama_ruang; ?></h6>
                    <h4 class="purple-text"><?php echo 'Peminjam : '. $detailPinjam->nama_user; ?></h4>
                    <h4 class="purple-text"><?php echo 'Acara : '. $detailPinjam->keterangan; ?></h4>
                </div> -->
