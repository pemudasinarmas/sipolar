    ...
    <div class="container">
        ...
        <form method="post">
            <div class="row">
                    ...
                    while ($data = $query->fetch_object()) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($data->id_hari == '1') {
                                    ?>
                                    <a href="<?php $baseUrl;?>landing.php?page=home&action=detail&detail_id=<?php echo $data->id_peminjaman; ?>" class="tippy <?php echo $color;?>" title="Lihat Detail">
                                        <?php
                ...
                if ($pagination > 1) {
                    $link = $pagination - 1;
                    $prev = "<a href='" . $baseUrl . "landing.php?&pagination=" . $link . "' class='btn purple'><i class='white-text mdi mdi-chevron-double-left'></i></a>";
                } else {
                ...
                if ($pagination < $amount_page) {
                    $link = $pagination + 1;
                    $next = "<a href='" . $baseUrl . "landing.php?&pagination=" . $link . "' class='btn purple'><i class='white-text mdi mdi-chevron-double-right'></i></a>";
                } else {
